...
const footerLinks = {
    services: [
        { href: "/services", label: "Wedding Bartending" },
        { href: "/services", label: "Corporate Events" },
        { href: "/services", label: "Private Parties" },
        { href: "/services", label: "Special Occasions" },
    ],
    company: [
                ...
                <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-12">
                    ...
                    <div className="lg:col-span-1">
                        ...
                        <p className="text-white/80 text-sm leading-relaxed mb-6">
                            Premium mobile bartending services for life&apos;s best moments.
                            Serving Philadelphia, Bensalem, Bucks County, and surrounding
                            PA/NJ areas.
                        </p>
                        {/* Social Links */}
                    ...
                    <div>
                        ...
                        <ul className="space-y-3 text-sm text-white/80">
                            <li className="flex items-start gap-3">
                                <svg
                                    className="w-5 h-5 mt-0.5 text-pink flex-shrink-0"
                                    fill="none"
                                    stroke="currentColor"
                                    viewBox="0 0 24 24"
                                >
            ...
            <div className="border-t border-white/10">
                <div className="container mx-auto px-6 py-6">
                    <div className="flex flex-col md:flex-row justify-between items-center gap-4 text-sm text-white/60">
                        <p>
                            © {new Date().getFullYear()} The Blooming Tini. All rights
                            reserved.
                        </p>
                        <p className="flex items-center gap-1">
                            Made with <span className="text-pink">♥</span> in Philadelphia
                        </p>
                    </div>
                </div>
            </div>
